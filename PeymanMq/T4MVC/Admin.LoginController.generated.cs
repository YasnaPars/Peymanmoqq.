...
namespace PeymanMq.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LoginController : PeymanMq.Areas.Admin.Controllers.LoginController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.LoginAdminVM item);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(BLL.LoginAdminVM item)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "item", item);
            IndexOverride(callInfo, item);
            return callInfo;
        }

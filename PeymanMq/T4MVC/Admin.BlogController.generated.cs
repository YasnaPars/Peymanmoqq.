...
namespace PeymanMq.Areas.Admin.Controllers
{
    public partial class BlogController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Details = "~/Areas/Admin/Views/Blog/Details.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/Blog/Index.cshtml";
            public readonly string Update = "~/Areas/Admin/Views/Blog/Update.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BlogController : PeymanMq.Areas.Admin.Controllers.BlogController
    {
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.Blog obj);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(BLL.Blog obj)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Update);
        ...
        [NonAction]
        partial void SelectOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, int pageIndex, int pageSize, short? category);

        [NonAction]
        public override System.Web.Mvc.JsonResult Select(int pageIndex, int pageSize, short? category)
        {
        ...
        [NonAction]
        partial void DeleteAllOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int[] list);

        [NonAction]
        public override System.Web.Mvc.ActionResult DeleteAll(int[] list)
        {
            ...
            DeleteAllOverride(callInfo, list);
            return callInfo;
        }

        [NonAction]
        partial void UpdateRankOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, int id, string type, int? category);

        [NonAction]
        public override System.Web.Mvc.JsonResult UpdateRank(int id, string type, int? category)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.UpdateRank);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "type", type);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "category", category);
            UpdateRankOverride(callInfo, id, type, category);
            return callInfo;
        }

...
namespace PeymanMq.Areas.Admin.Controllers
{
    public partial class PanelController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/Panel/Index.cshtml";
            public readonly string Update = "~/Areas/Admin/Views/Panel/Update.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PanelController : PeymanMq.Areas.Admin.Controllers.PanelController
    {
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.Panel obj);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(BLL.Panel obj)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Update);

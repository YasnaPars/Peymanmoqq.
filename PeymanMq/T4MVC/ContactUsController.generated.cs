...
namespace PeymanMq.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ContactUsController : PeymanMq.Controllers.ContactUsController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.ContactInsertVM model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(BLL.ContactInsertVM model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);

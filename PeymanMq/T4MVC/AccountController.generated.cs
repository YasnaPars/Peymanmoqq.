...
namespace PeymanMq.Controllers
{
    public partial class AccountController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult RecoverPassword()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RecoverPassword);
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string RecoverPassword = "~/Views/Account/RecoverPassword.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : PeymanMq.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void ForgetPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.UserSiteRecoverPasswordVM obj);

        [NonAction]
        public override System.Web.Mvc.ActionResult ForgetPassword(BLL.UserSiteRecoverPasswordVM obj)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ForgetPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "obj", obj);
            ForgetPasswordOverride(callInfo, obj);
            return callInfo;
        }

        [NonAction]
        partial void RecoverPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string key);

        [NonAction]
        public override System.Web.Mvc.ActionResult RecoverPassword(string key)
        {
            ...
            RecoverPasswordOverride(callInfo, key);
            return callInfo;
        }

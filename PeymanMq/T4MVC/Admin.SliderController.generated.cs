...
namespace PeymanMq.Areas.Admin.Controllers
{
    public partial class SliderController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Update = "~/Areas/Admin/Views/Slider/Update.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SliderController : PeymanMq.Areas.Admin.Controllers.SliderController
    {
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.Slider obj);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(BLL.Slider obj)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Update);

...
namespace PeymanMq.Controllers
{
    public partial class ErrorController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string Index = "Index";
                public readonly string Index500 = "Index500";
            }
            public readonly string Index = "~/Views/Error/Index.cshtml";
            public readonly string Index500 = "~/Views/Error/Index500.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ErrorController : PeymanMq.Controllers.ErrorController
    {

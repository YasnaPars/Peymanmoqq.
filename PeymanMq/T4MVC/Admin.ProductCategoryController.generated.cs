...
namespace PeymanMq.Areas.Admin.Controllers
{
    public partial class ProductCategoryController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProductCategoryController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductCategoryController Actions { get { return MVC.Admin.ProductCategory; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductCategory";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductCategory";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/ProductCategory/Index.cshtml";
            public readonly string Update = "~/Areas/Admin/Views/ProductCategory/Update.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductCategoryController : PeymanMq.Areas.Admin.Controllers.ProductCategoryController
    {
        public T4MVC_ProductCategoryController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.ProductCategory obj);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(BLL.ProductCategory obj)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Update);

...
namespace PeymanMq.Areas.Admin.Controllers
{
    public partial class CertificateController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CertificateController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CertificateController Actions { get { return MVC.Admin.Certificate; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Certificate";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Certificate";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/Certificate/Index.cshtml";
            public readonly string Update = "~/Areas/Admin/Views/Certificate/Update.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CertificateController : PeymanMq.Areas.Admin.Controllers.CertificateController
    {
        public T4MVC_CertificateController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BLL.Certificate obj);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(BLL.Certificate obj)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Update);

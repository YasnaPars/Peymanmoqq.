...
(function ($) {
    ...
    $.fn.tagEditorInput = function () { var t = " ", e = $(this), n = parseInt(e.css("fontSize")), i = $("<span/>").css({ position: "absolute", top: -9999, right: -9999, width: "auto", fontSize: e.css("fontSize"), fontFamily: e.css("fontFamily"), fontWeight: e.css("fontWeight"), letterSpacing: e.css("letterSpacing"), whiteSpace: "nowrap" }), s = function () { if (t !== (t = e.val())) { i.text(t); var s = i.width() + n; 20 > s && (s = 20), s != e.width() && e.width(s) } }; return i.insertAfter(e), e.bind("keyup keydown focus", s) };
    ...
    $.fn.tagEditor = function (options, val, blur) {
        ...
        return selector.each(function () {
                ...
                if (closest_tag && closest_tag.length)
                    ...
                    $('.tag-editor-tag', ed).each(function () {
                        ...
                        if (e.pageY >= tag_y && e.pageY <= tag_y + tag.height()) {
                            if (e.pageX < tag_x) loc = 'after', d = tag_x - e.pageX;
                            else loc = 'before', d = e.pageX - tag_x - tag.width();
            ...
            ed.on('keydown', 'input', function (e) {
                ...
                if ((e.which == 39 || !o.autocomplete && e.which == 38) && !$t.caret() || e.which == 8 && !$t.val()) {
                    ...
                    // right/down key
                else if ((e.which == 37 || !o.autocomplete && e.which == 40) && ($t.caret() == $t.val().length)) {
